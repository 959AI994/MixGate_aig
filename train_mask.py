...
if __name__ == '__main__':
    ...
    circuit_path ='/home/jwt/Multi-Gate/new_merged.npz'
    ...
    model = mixgate.top_model.TopModel(
        args, 
        # dc_ckpt='./ckpt/dc.pth', 
        dg_ckpt_aig='/home/jwt/MixGate/ckpt/model_aig.pth',
        dg_ckpt_xag='/home/jwt/MixGate/ckpt/model_xag.pth',
        dg_ckpt_xmg='/home/jwt/MixGate/ckpt/model_xmg.pth',
        dg_ckpt_mig='/home/jwt/MixGate/ckpt/model_mig.pth'
    )
    ...
    trainer.set_training_args(lr=1e-4, lr_step=50, loss_weight = [1.0, 1.0, 0])
    print('[INFO] Stage 1 Training ...')
    trainer.train(num_epochs, train_dataset, val_dataset)

    print('[INFO] Stage 2 Training ...')
    trainer.set_training_args(loss_weight = [3.0, 1.0, 2.0], lr=1e-4, lr_step=50)
    trainer.train(num_epochs, train_dataset, val_dataset)
